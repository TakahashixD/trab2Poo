...
public class TelaRemoverM extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TelaRemoverM frame = new TelaRemoverM();
	...
	public TelaRemoverM() {
		...
		JLabel lblEscolhaORecurso = new JLabel("Escolha qual recurso a ser removido:");
		...
		btnRecursoHumano.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				TelaRemoverHumano prox = new TelaRemoverHumano();
		...
		btnRecursoMaterial.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				TelaRemoverMaterial prox = new TelaRemoverMaterial();
				prox.setVisible(true);
				dispose();
			}
		});
