...
public class TelaAtualizarM extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TelaAtualizarM frame = new TelaAtualizarM();
	...
	public TelaAtualizarM() {
		...
		JLabel lblEscolhaORecurso = new JLabel("Escolha qual recurso a ser atualizado:");
		...
		btnRecursoHumano.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				TelaAtualizarHumano prox = new TelaAtualizarHumano();
		...
		btnRecursoMaterial.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				TelaAtualizarMaterial prox = new TelaAtualizarMaterial();
				prox.setVisible(true);
				dispose();
			}
		});
